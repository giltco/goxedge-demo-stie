...
var GOXEDGE_MODEL = {
  ...
  layersSummary: [
    { title: '战略推进机制层', text: '认知—行动—反馈贯穿六阶段，帮助企业在推进过程中持续校准判断、行动和组织承接。' },
    { title: '战略路径层', text: '探索、定位、执行、赋能、优化、可持续六阶段，组织企业从前期判断走向长期经营。' },
    { title: '战略能力支撑层', text: '专业性、多元化、增长力、赋能力贯穿六阶段，保证路径不是停留在流程上，而能转化为企业真实能力。' },
    { title: '战略判断层', text: '围绕环境与趋势、战略意图、战略锚点、资源能力、路径优先级和风险边界，回答能否启动、从哪里启动、路径如何设计。' }
  ]
};
